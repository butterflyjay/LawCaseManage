 ...
 */
SecurityFactory.authType = 0;
/**
 * 数据存储类型，0内存 1redis
 */
SecurityFactory.saveType = 0;
/**
 * redis名，必须在redis.json中已定义,saveType=1时有效
 */
SecurityFactory.redis = 'default';
/**
 * 安全相关页面map
 */
 ...
 * 用户id对应session键
 */
SecurityFactory.USERID = 'NSECURITY_USERID';
/**
 * 认证前url在session中的名字
 */
SecurityFactory.PRELOGIN = 'NSECURITY_PRELOGIN';
/**
 * users在cache的key
 */
SecurityFactory.redisUserKey = "NOOMI_SECURITY_USERS";
/**
 * groups在cache的key
 */
SecurityFactory.redisGroupKey = "NOOMI_SECURITY_GROUPS";
/**
 * resource在cache的key
 */
SecurityFactory.redisResourceKey = "NOOMI_SECURITY_RESOURCES";
