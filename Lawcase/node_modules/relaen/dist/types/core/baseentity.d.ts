 ...
 * 实体基类
 */
export declare class BaseEntity extends Object implements IEntity {
    /**
     * 状态
     */
    ...
    static find(id: any): Promise<IEntity>;
    /**
     * 根据条件查询单个实体
     ...
     * @since 0.2.0
     */
    static findMany(params?: object, start?: number, limit?: number, order?: object): Promise<Array<IEntity>>;
    /**
     * 获取记录数
